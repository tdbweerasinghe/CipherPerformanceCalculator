...
public class TripleDESEncrypter {
    ...
    public static void main(String[] args) throws Exception {
        ...
        encryptionBytes = TripleDES_Encrypt(input);
        ...
        //Decryption
        String recoveredString = TripleDES_Decrypt(encryptionBytes);
        //Get the current system time in milliseconds 
    ...
    public static byte[] TripleDES_Encrypt(String input)
    ...
    public static String TripleDES_Decrypt(byte[] encryptionBytes)
            throws InvalidKeyException,
            BadPaddingException,
            IllegalBlockSizeException {
